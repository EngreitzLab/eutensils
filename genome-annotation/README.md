...
### Inputs
1. GENCODE GTF file (download from https://www.gencodegenes.org/human/release_43.html) 
...
### Run
1. If using additional annotations, convert the raw UCSC download to `TSS500bp.bed` format with header `#chr	start	end	name	score	strand	transcript_id	source`
